...
interface SnapshotFormDialogProps {
  ...
  latest_notes?: string;
  treeData?: Observation[];
  shrubData?: Observation[];
  grassData?: Observation[];
  otherData?: Observation[];
}

const SnapshotFormDialog: React.FC<SnapshotFormDialogProps> = ({
  newSnapshot,
  patchLabel,
  latest_date,
  latest_notes,
...
export default SnapshotFormDialog;
